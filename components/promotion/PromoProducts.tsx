      ...
      <div className="promotion-products__container">
        ...
        <div className="promotion-products__box">
          <div className="promotion-products__filter">
            <div className="promotion-products__filter-item">
              <input type="radio" name="sort_by" id={"sort_by_1"} />
              <label htmlFor="sort_by_1">
                Смартфоны
                <span>
                  <svg
                    width="29"
            ...
            <div className="promotion-products__filter-item">
              <input type="radio" name="sort_by" id={"sort_by_2"} />
              <label htmlFor="sort_by_2">
                Наушники
                <span>
                  <svg
                    width="29"
            ...
            <div className="promotion-products__filter-item">
              <input type="radio" name="sort_by" id={"sort_by_3"} />
              <label htmlFor="sort_by_3">
                Смарт-часы
                <span>
                  <svg
                    width="29"
