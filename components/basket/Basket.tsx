              ...
              <div className="basket-receipt__sections">
                <div className="basket-receipt__section">
                  <div className="basket-receipt__item">
                    ...
                    <div className="basket-receipt__item-value">{quantity}</div>
                  </div>
                  <div className="basket-receipt__item">
                  ...
                  <div className="product-actions__basket-info">
                    <div className="product-actions__basket-info-item">
                      ...
                      <div className="product-actions__basket-info-value">
                        <p>
                          {Math.round(
                            parseFloat(basket?.total_incl_tax) / 60
                          ).toLocaleString()}{" "}
                          ₸ х 60 мес
                        </p>
                      </div>
                    ...
                    <div className="product-actions__basket-info-item">
                      ...
                      <div className="product-actions__basket-info-value">
                        <p>
                          {Math.round(
                            parseFloat(basket?.total_incl_tax) / 24
                          ).toLocaleString()}{" "}
                          ₸ х 24 мес
                        </p>
                        <p>
                          {Math.round(
                            parseFloat(basket?.total_incl_tax) / 12
                          ).toLocaleString()}{" "}
                          ₸ х 12 мес
                        </p>
                        <p>
                          {Math.round(
                            parseFloat(basket?.total_incl_tax) / 6
                          ).toLocaleString()}{" "}
                          ₸ х 6 мес
                        </p>
                      </div>
